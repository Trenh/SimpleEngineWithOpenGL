...
void Game::load()
{
	Assets::loadShader("Resources\\Shaders\\Sprite.vert", "Resources\\Shaders\\Sprite.frag", "", "", "", "Sprite");
	Assets::loadShader("Resources\\Shaders\\BasicMesh.vert", "Resources\\Shaders\\BasicMesh.frag", "", "", "", "BasicMesh");
	Assets::loadShader("Resources\\Shaders\\Phong.vert", "Resources\\Shaders\\Phong.frag", "", "", "", "Phong");
	...
	Assets::loadMesh( "Resources\\Meshes\\Cube.gpmesh", "Mesh_Cube");
	Assets::loadMesh( "Resources\\Meshes\\Plane.gpmesh", "Mesh_Plane");
	Assets::loadMesh( "Resources\\Meshes\\Sphere.gpmesh", "Mesh_Sphere");
	...
	q = Quaternion(Vector3::unitY, Maths::pi-0.0001);
...
void Game::processInput()
{
	...
	for (auto actor : actors)
	{
		...
		actor->actorInput(emouse.button);
	}
